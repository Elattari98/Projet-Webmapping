...
<div class="page-title">
    <div class="container text-center">
        <h3>Convertir un fichier shp en GeoJSON</h3>
...
<div class="container section-padding">
     ...
     <div class="section-title">
                           ...
                           <center> <p>
                           <b> SELECT </b>ST_AsGeoJSON(geom) As geom
                           <b> FROM </b>regions;
                            </p></center>
...
<center>
        <?php
            ...
            $requete = $bdd->query("SELECT ST_AsGeoJSON(geom) As geom FROM regions");
            ?>
            <table border="1">
            <?php
                    while($resultat = $requete->fetch())
                    {
                       ...
                       <td></td>
                       <td><?php echo $resultat['geom']."<br />";?></td>
                    </tr>
