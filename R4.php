...
<div class="page-title">
    <div class="container text-center">
        <h3>Quelle est la plus longue route de Rabat sale où la circulation est fluide ? </h3>
...
<center>
        <?php
            ...
            $requete = $bdd->query("SELECT * FROM routesrabatsale ORDER BY length DESC LIMIT 1");
            ?>
            <table border="1">
            <?php
