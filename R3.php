...
<div class="page-title">
    <div class="container text-center">
        <h3>Quelle région contient le plus grand nombre de populations en 2014 ? </h3>
...
<div class="container section-padding">
     ...
     <div class="section-title">
                           ...
                           <center> <p>
                           <b> SELECT </b>gid, region, rgph14
                           <b> FROM </b>regions
                           <b>ORDER BY</b> rgph14 <b>DESC</b>
                           <b>LIMIT</b> 1; 
                            </p></center>
...
<center>
        <?php
            ...
            $requete = $bdd->query("SELECT * FROM regions ORDER BY rgph14 DESC LIMIT 1");
            ?>
            <table border="1">
            <?php
                    ...
                    <tr>
                       ...
                       <td><?php echo $resultat['region'];?></td>
                    </tr>
                    <tr>
                       <td></td>
                       <td><?php echo $resultat['rgph14']."<br />";?></td>
                    </tr>
                    <?php
                    }
                    ?>
